...
## 4. CREACIÓN DE PÚBLICOS POR URLS VIRTUALES (NUEVA IMPLEMENTACIÓN)

Debido a que la página web es una SPA (Single Page Application) y los Eventos Personalizados a veces tardan en madurar en Meta, hemos implementado **URLs Virtuales Seguras (Parámetros)**. Esto permite crear públicos inmediatamente y sin riesgo.
