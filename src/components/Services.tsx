...
const services = [
  {
    id: "kitchens",
    titleKey: "services.kitchens.title",
    descKey: "services.kitchens.desc",
    icon: Grid,
    image: "/services/cocinas/cocina.1.jpg",
  },
  {
    id: "closets",
    titleKey: "services.closets.title",
    descKey: "services.closets.desc",
    icon: Box,
    image: "/services/closets/closet (1).png",
  },
  {
    id: "cnc",
    titleKey: "services.cnc.title",
    descKey: "services.cnc.desc",
    icon: Layers,
    image: "/services/cnc/CNC CUTTING SERVICE (1).jpeg",
  },
  {
    id: "panels",
    titleKey: "services.panels.title",
    descKey: "services.panels.desc",
    icon: Columns,
      ...
      <section id="services" className="py-32 bg-matte-black relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col items-center mb-20 text-center">
            ...
            >
              {t("services.title1")} <span className="text-gradient-bronze">{t("services.title2")}</span>
            </motion.h2>
              ...
              return (
                <motion.div
                  ...
                  onClick={() => {
                    ...
                    trackMetaEvent('ViewService', { service_name: title }, true);
                  }}
